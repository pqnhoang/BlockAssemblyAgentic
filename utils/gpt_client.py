...
class GPTClient:
    ...
    @classmethod
    def _load_api_key(cls, api_file="/Users/pqnhhh/Documents/GitHub/RDM/api.key"):
    ...
    @classmethod
    def _get_instance(cls, api_file="/Users/pqnhhh/Documents/GitHub/RDM/api.key"):
    ...
    def prompt_gpt(
        ...
        temperature=0,
        system_message=None,
        api_file="/Users/pqnhhh/Documents/GitHub/RDM/api.key",
    ):
        """
    ...
    @classmethod
    def get_image_from_dalle(cls, prompt, img_save_path, api_file="/Users/pqnhhh/Documents/GitHub/RDM/api.key"):
        client = cls._get_instance(api_file)
