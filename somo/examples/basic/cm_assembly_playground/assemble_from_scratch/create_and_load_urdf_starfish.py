...
offset_0= [-0.014, 0.014, 0.0, 0.0, 1.5707963267948966, 3.141592653589793]
offset_1= [0.014, -0.014, 0.0, 0.0, 1.5707963267948966, -0.0]
offset_2= [0, 0, 0, np.pi/3, 0, np.pi/3]
offset_3= [0, 0, 0, 0, -np.pi/3, np.pi/3]
offset_3= [0, 0, 0, -np.pi/3, -np.pi/3, np.pi/3]
manipulator_definition_pairs.append((manipulator_definition, offset_0))
manipulator_definition_pairs.append((manipulator_definition, offset_1))
...
for i in range(n_steps):
    ...
    time.sleep(0.01)  # slow down the simulation for visualization purposes
    p.stepSimulation()
