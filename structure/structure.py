...
from utils.transform_utils import quat2mat, angular_error
...
from pybullet_utils.pybullet_axes import get_imgs
import time
...
class Structure:
    ...
    def place_blocks(self, drop=True, debug=False):
        p.resetSimulation()
        # Create a simple ground plane instead of loading URDF
